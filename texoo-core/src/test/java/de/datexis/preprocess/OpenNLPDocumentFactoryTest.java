 ...
 */
public class OpenNLPDocumentFactoryTest {

  protected final static Logger log = LoggerFactory.getLogger(OpenNLPDocumentFactoryTest.class);
  ...
  public void testSentenceSplitting() {
    Document doc;
    doc = OpenNLPDocumentFactory.fromText(text, OpenNLPDocumentFactory.Newlines.DISCARD);
  ...
  public void testNewLines() {
    Document doc;
    doc = OpenNLPDocumentFactory.fromText(text, OpenNLPDocumentFactory.Newlines.KEEP);
    Assert.assertEquals(5, doc.countSentences());
  ...
  public void testSentenceBoundaries() {
    ...
    Document doc = OpenNLPDocumentFactory.fromText(text,OpenNLPDocumentFactory.Newlines.DISCARD);
